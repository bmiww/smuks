...
(DEFMETHOD GET-REQUEST-ARG-TYPES ((OBJ WL_SHM_POOL) OPCODE)
  (NTH OPCODE '((NEW_ID INT INT INT INT UINT) NIL (INT))))
...
(DEFMETHOD GET-REQUEST-ARG-TYPES ((OBJ WL_DATA_OFFER) OPCODE)
  (NTH OPCODE '((UINT STRING) (STRING FD) NIL NIL (UINT UINT))))
...
(DEFMETHOD GET-REQUEST-ARG-TYPES ((OBJ WL_SHELL_SURFACE) OPCODE)
  (NTH OPCODE
       '((UINT) (OBJECT UINT) (OBJECT UINT UINT) NIL (OBJECT INT INT UINT)
         (UINT UINT OBJECT) (OBJECT UINT OBJECT INT INT UINT) (OBJECT) (STRING)
         (STRING))))
